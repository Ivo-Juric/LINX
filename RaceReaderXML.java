...
public class RaceReaderXML {
    public static ArrayList<Race> xmlRaceReader() {
        ...
        try {
            File inputFile = new File("C:\\Users\\Nicolas\\Desktop\\Facultad\\Programacion B\\triatlon.xml");
    ...
    private static List<Provisioning> parseProvisioning(Element eElement) {
        NodeList provisioningList = eElement.getElementsByTagName("puesto"); // Cambia a "puesto" para obtener todos los nodos de tipo puesto
